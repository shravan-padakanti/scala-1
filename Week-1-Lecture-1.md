...
# Problem: 
The imperative programming is what programmers use mostly in their day to day life. The problem is **scaling**. How can we avoid conceptualizing programs word by word?
